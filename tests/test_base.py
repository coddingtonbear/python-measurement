...
class TestMetricUnit:
    ...
    def test_get_symbols__unique_names(self) -> None:
        metre = MetricUnit("1", ["m", "meter"], ["m"], ["metre", "meter"])
        metre.name = "metre"
        symbols = list(metre.get_symbols())
...
class TestAbstractMeasure:
    ...
    def test_eq__not_implemented(self) -> None:
    ...
    def test_lt__not_implemented(self) -> None:
    ...
    def test_gt__not_implemented(self) -> None:
    ...
    def test_add__raise__type_error(self) -> None:
    ...
    def test_sub__raise__type_error(self) -> None:
        with pytest.raises(TypeError) as e:
            self.measure(**{self.unit: 2}) - "not-allowed"
        assert (
            str(e.value)
    ...
    def test_mul__raise__type_error(self) -> None:
        with pytest.raises(TypeError) as e:
            self.measure(**{self.unit: 2}) * "not-allowed"
        assert (
    ...
    def test_mul__raise_for_same_type(self) -> None:
        with pytest.raises(TypeError) as e:
            Mass("1 kg") * Mass("1 kg")
    ...
    def test_truediv__raise__type_error(self) -> None:
        with pytest.raises(TypeError) as e:
            self.measure(**{self.unit: 2}) / "not-allowed"
